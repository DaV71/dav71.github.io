...
export default function BlogPost({ post, prevPost, nextPost }) {
  ...
  return (
    <>
      <Head>
        <title>{post.title} - IT Solutions Blog</title>
        <meta name="description" content={post.excerpt} />
        <meta name="keywords" content={`${post.title}, IT Solutions, blog, poradniki, ${post.category.toLowerCase()}`} />
        <meta name="author" content="IT Solutions" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://itsolutions.pl/blog/${post.slug}`} />
        <meta property="og:title" content={post.title} />
        <meta property="og:description" content={post.excerpt} />
        <meta property="og:image" content={post.image} />
        <meta property="article:published_time" content={post.date} />
        <meta property="article:author" content="IT Solutions" />
        <meta property="article:section" content={post.category} />

        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content={`https://itsolutions.pl/blog/${post.slug}`} />
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "publisher": {
                ...
                "logo": {
                  "@type": "ImageObject",
                  "url": "https://itsolutions.pl/logo.png"
                }
              },
              ...
              "mainEntityOfPage": {
                "@type": "WebPage",
                "@id": `https://itsolutions.pl/blog/${post.slug}`
              }
            })
          }}
        />
                ...
                >
                  ...
                  <Link href={`/blog/${prevPost.slug}`} className="group">
                    ...
                    <p className="text-gray-600 text-sm">
                      {prevPost.excerpt.substring(0, 100)}...
                    </p>
                  </Link>
                </motion.div>
              )}
              ...
              {nextPost && (
                ...
                >
                  ...
                  <Link href={`/blog/${nextPost.slug}`} className="group">
                    ...
                    <p className="text-gray-600 text-sm">
                      {nextPost.excerpt.substring(0, 100)}...
                    </p>
                  </Link>
                </motion.div>
              )}
